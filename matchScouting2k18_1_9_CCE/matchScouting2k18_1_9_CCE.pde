...
boolean allia = false;
float buttonLocationsX = 0.6;
float buttonLocationsY = 0.6;
float invisButtonLocationsX = 0.6;
float invisButtonLocationsY = 0.6;
float widthS = 0.6;
float heightS = 0.6;
//Counter Variables
...
void setup () {
  ...
  //on all pages
  alliance = new textBox(buttonLocationsX*1550, buttonLocationsY * 10, widthS*80, heightS*80, 0, 0, 255, 0, 0, 0, "", false, false, true);

  //page 1
  tournament = new checkBoxGroup(buttonLocationsX*140, buttonLocationsY * 482, 200, 200, 200, 2, 0);
  ...
  disabled = new checkBox(buttonLocationsX*600, buttonLocationsY * 870, 200, 200, 200, false, "Disabled");
  potf = new checkBox(buttonLocationsX*600, buttonLocationsY * 960, 200, 200, 200, false, "Parts On the Field");
  flippedOver = new checkBox(buttonLocationsX*600, buttonLocationsY * 1050, 200, 200, 200, false, "Flipped Over");
  attemptedClimb = new checkBox(buttonLocationsX*1000, buttonLocationsY * 870, 200, 200, 200, false, "Attempted Climb");
  successfulClimb = new checkBox(buttonLocationsX*1000, buttonLocationsY * 960, 200, 200, 200, false, "Successful Climb");
  noShow = new checkBox(buttonLocationsX*70, buttonLocationsY * 970, 200, 200, 200, false, "No Show"); //1000, 1050
  yellowCard = new checkBox(buttonLocationsX *1132, buttonLocationsY * 870, 200, 200, 200, false, "Yellow Card");
  redCard = new checkBox(buttonLocationsX*1132, buttonLocationsY * 960, 200, 200, 200, false, "Red Card");
  techFoul1 = new checkBox(buttonLocationsX*1132, buttonLocationsY * 1050, 200, 200, 200, false, "Tech Foul");
  foul1 = new checkBox(buttonLocationsX*1400, buttonLocationsY * 1050, 200, 200, 200, false, "Foul");
  assistedClimb = new checkBox(buttonLocationsX*1000, buttonLocationsY * 1050, 200, 200, 200, false, "Assisted Climb");//70, 970
...
void draw() {
  ...
  image(blackOnTrans, buttonLocationsX * 0, buttonLocationsY *0);
  noTint();

  fill(255);
  rect(buttonLocationsX * 10, buttonLocationsY * 10, 420, 80);
  //title
  textFont(font, 40);
  fill(0);
  text("Match Scouting 2018!", buttonLocationsX *20, buttonLocationsY * 60);
  alliance.draw();
  text("Alliance (Blue/Red)", buttonLocationsX * 1200, buttonLocationsY * 60);
  ...
  if (page == 1) {
    ...
    flipField.draw();
    fill(255);
    text("Match Number:", buttonLocationsX * 10, buttonLocationsY * 850);
    text("Tournament", buttonLocationsX * 130, buttonLocationsY * 540);
    text("DO NOT PRESS FLIP FIELD UNLESS ABSOLUTELY NESSCESSARY", buttonLocationsX - 966, buttonLocationsY-18);
  } else if (page == 2) {

    line(buttonLocationsX * 1920, 0, buttonLocationsX * 1920, buttonLocationsY+432);
    fill(255);

    textFont(font, 32);
    text("Team Number: "+ teamNumber.input, buttonLocationsX * 440, buttonLocationsY * 60);
    text("Autonomous", buttonLocationsX * 490, buttonLocationsY * 210);
    text("Teleop", buttonLocationsX * 1420, buttonLocationsY * 210);

    if (flipField.isChecked) {
      flippedField.resize(1800, 650);
      image(flippedField, buttonLocationsX * 50, buttonLocationsY * 150);
    } else {
      //field.resize(1800, 650);
      image(field, buttonLocationsX * 50, buttonLocationsY * 150);
    }
    ...
    if (flipField.isChecked == true && child.alliance == 1) { // flipped scouting red
      exchangeDropoff.moveButton(buttonLocationsX * 1590);
      exchangePickup.moveButton(buttonLocationsX * 1470);
      cubePileZone.moveButton(buttonLocationsX * 1350);
      allianceSwitch.moveButton(buttonLocationsX * 1532);
      cubeLineZone.moveButton(buttonLocationsX * 1662);
      opponentCubeLineZone.moveButton(buttonLocationsX * 700);
      opponentSwitch.moveButton(buttonLocationsX * 550);
      portal.moveButton(buttonLocationsX * 71);
    } else if (flipField.isChecked == true && child.alliance == 2) {// flipped scouting blue
      exchangeDropoff.moveButton(buttonLocationsX * 75);
      exchangePickup.moveButton(buttonLocationsX * 310);
      cubePileZone.moveButton(buttonLocationsX * 310);
      allianceSwitch.moveButton(buttonLocationsX * 550);
      cubeLineZone.moveButton(buttonLocationsX * 700);
      opponentCubeLineZone.moveButton(buttonLocationsX * 1070);
      opponentSwitch.moveButton(buttonLocationsX * 1200);
      portal.moveButton(buttonLocationsX * 1590);
    } else if (flipField.isChecked == false && child.alliance == 1) {// not flipped scouting red
      exchangeDropoff.moveButton(buttonLocationsX * 71);
      exchangePickup.moveButton(buttonLocationsX * 310);
      cubePileZone.moveButton(buttonLocationsX * 430);
      allianceSwitch.moveButton(buttonLocationsX * 550);
      cubeLineZone.moveButton(buttonLocationsX * 700);
      opponentCubeLineZone.moveButton(buttonLocationsX * 1070);
      opponentSwitch.moveButton(buttonLocationsX * 1200);
      ...
      exchangePickup.moveButton(buttonLocationsX * 1470);
      cubePileZone.moveButton(buttonLocationsX * 1350);
      allianceSwitch.moveButton(buttonLocationsX * 1200);
      cubeLineZone.moveButton(buttonLocationsX * 1070);
      opponentCubeLineZone.moveButton(buttonLocationsX *  700);
      opponentSwitch.moveButton(buttonLocationsX * 550);
      portal.moveButton(buttonLocationsX * 75);
    }
    ...
    fill(0);
    rect(buttonLocationsX * 0, buttonLocationsY * 1140, 800, 60);
    ...
    text( printButtonPressed, buttonLocationsX * 0, buttonLocationsY * 1165);
  } 
  if (page==3) {
    fill(255);
    text("Ending Alliance Points:", buttonLocationsX * 10, buttonLocationsY * 300);
    text("Ranking Points:", buttonLocationsX -1356, buttonLocationsY * 480);
    text("Overall Performance Rating:", buttonLocationsX * 10, buttonLocationsY * 670);
    text("Defense Rating:", buttonLocationsX * 10, buttonLocationsY * 670);
    text("Offense Rating:", buttonLocationsX * 10, buttonLocationsY * 1050);
    textFont(font, 32);
    text("Team Number: "+ teamNumber.input, buttonLocationsX * 440, buttonLocationsY * 60);
    ...
    fill(255);
    text("1           2           3             4", buttonLocationsX * 350, buttonLocationsY * 425);
    text("1            2           3            4           5", buttonLocationsX * 560, buttonLocationsY * 615);
    text("1            2           3            4           5", buttonLocationsX * 350, buttonLocationsY * 805);
    text("1            2           3            4           5", buttonLocationsX * 350, buttonLocationsY * 995);
  }
}
...
void saveCycleTime(int Path, float seconds, int currPathCount, boolean isAuto, boolean cycle) {
  ...
  if (disabled.isChecked == true) {
    disabledOutput=1;
  } else {
    disabledOutput=0;
  }
  if (potf.isChecked == true) {
    POTFOutput=1;
  } else {
    POTFOutput=0;
  }
  if (flippedOver.isChecked == true) {
    flippedOutput=1;
  } else {
    flippedOutput=0;
  }
  if (attemptedClimb.isChecked == true) {
    attemptedOutput=1;
  } else {
    attemptedOutput=0;
  }
  if (successfulClimb.isChecked == true) {
    successfulOutput=1;
  } else {
    successfulOutput=0;
  }
